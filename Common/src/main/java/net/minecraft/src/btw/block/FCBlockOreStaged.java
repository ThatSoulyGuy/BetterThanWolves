...
public abstract class FCBlockOreStaged extends FCBlockOre
{
    ...
    public void EjectItemsOnGoodPickConversion( ItemStack stack, World world, int i, int j, int k, int iOldMetadata, int iFromSide )
    {
    ...
    public void EjectItemsOnStonePickConversion( ItemStack stack, World world, int i, int j, int k, int iOldMetadata, int iFromSide )
    {
        FCUtilsItem.EjectStackFromBlockTowardsFacing( world, i, j, k, 
    ...
    public void EjectItemsOnChiselConversion( ItemStack stack, World world, int i, int j, int k, int iOldMetadata, int iFromSide )
    {
        FCUtilsItem.EjectStackFromBlockTowardsFacing( world, i, j, k, 
