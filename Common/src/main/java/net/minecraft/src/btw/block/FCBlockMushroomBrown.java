...
{
    public FCBlockMushroomBrown( int iBlockID, String iconName )
    {
    ...
    public boolean CanSpreadToOrFromLocation( World world, int i, int j, int k )
	{
    ...
    public void CheckForSpread( World world, int i, int j, int k, Random rand )
    {
