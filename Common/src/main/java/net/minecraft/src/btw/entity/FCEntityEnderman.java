...
{	
    ...
    public int m_iTeleportDelay = 0;
    public int m_iAggressionCounter = 0; // field_70826_g in parent
    public boolean m_bShouldBeScreaming; // field_104003_g in parent
    ...
    public boolean IsPlayerStaringAtMe( EntityPlayer player )
    {
    ...
    public void AngerNearbyEndermen( EntityPlayer targetPlayer )
    {
