...
{
    public FCEntityWolf m_AssociatedWolf;
    public World m_World;
    
    public int m_iHowlCounter;
    public boolean m_iHowlingGroupInitiator;
    
    public static final int m_iChanceOfHowling = 4800;  // chance is 1 over value per tick
    public static final int m_iChanceOfHowlingDuringFullMoon = 240;
    public static final int m_iChanceOfHowlingWhenOthersHowl = 240;
    
    public static final int m_iHowlDuration = 80;
    public static final int m_iHeardHowlDuration = 95;
    public static final double m_dHearHowlDistance = 320D;
    public static final double m_dHearHowlDistanceSQ = ( m_dHearHowlDistance * m_dHearHowlDistance );
