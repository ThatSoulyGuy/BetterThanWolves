    ...
    implements IInventory, FCITileEntityDataPacketHandler
{
    ...
    public ItemStack m_Contents[];
    public int m_iCookCounter;
    
    public int m_iStokedCooldownCounter;
    
    public boolean m_bContainsValidIngrediantsForState;
    private boolean m_bForceValidateOnUpdate;
    
    public int m_iFireUnderType; // 0 = none, 1 = normal, 2 = stoked, -1 = requires validation
    ...
    public abstract FCCraftingManagerBulk GetCraftingManager( int iFireType );
    ...
    public boolean DoesContainExplosives()
    {
