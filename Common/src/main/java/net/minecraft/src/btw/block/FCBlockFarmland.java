...
public class FCBlockFarmland extends FCBlockFarmlandBase
{
    ...
    public FCBlockFarmland( int iBlockID )
    {
    	super( iBlockID );    	
	...
	public int GetWeedsGrowthLevel( int iMetadata )
	{
		return ( iMetadata & 14 ) >> 1;
	}
	
	public void SetWeedsGrowthLevel( World world, int i, int j, int k, int iGrowthLevel )
	{
	...
	public int SetWeedsGrowthLevel( int iMetadata, int iGrowthLevel )
	{
