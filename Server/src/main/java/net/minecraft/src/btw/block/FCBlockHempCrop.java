...
public class FCBlockHempCrop extends BlockCrops
{
    ...
    public FCBlockHempCrop( int iBlockID )
    {
        super( iBlockID );
    ...
    public boolean GetIsTopBlock( IBlockAccess blockAccess, int i, int j, int k )
    {
    	return GetIsTopBlock( blockAccess.getBlockMetadata( i, j, k ) );
    }
    
    public boolean GetIsTopBlock( int iMetadata )
    {
    	return ( iMetadata & 8 ) != 0;
    }
    
    public void SetIsTopBlock( World world, int i, int j, int k, boolean bTop )
    {
    ...
    public int SetIsTopBlock( int iMetadata, boolean bTop )
    {
    	if ( bTop )
    	{
    		iMetadata |= 8;
