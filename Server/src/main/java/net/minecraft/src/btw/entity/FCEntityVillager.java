...
public class FCEntityVillager extends EntityVillager
{
	...
	public static final int m_iInLoveDataWatcherID = 22;	
	public static final int m_iTradeLevelDataWatcherID = 23;
	
	// data watcher 24 used by EntityCreature parent to indicate possession
	
	public static final int m_iTradeExperienceDataWatcherID = 25; 
	public static final int m_iDirtyPeasantDataWatcherID = 26;
	
    public int m_iAIFullTickCountdown;
    public int m_iUpdateTradesCountdown;
    ...
    public void CheckForNewTrades( int iMaxNumTradesToAdd )
    {
    ...
    public void GenerateRandomParticles( String sParticle )
    {
