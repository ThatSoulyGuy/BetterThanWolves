...
public abstract class FCItemFireStarter extends Item
{
    ...
    public abstract boolean CheckChanceOfStart( ItemStack stack, Random rand );
    ...
    public boolean AttemptToLightBlockRegardlessOfFlamability( ItemStack stack, World world, int i, int j, int k, int iFacing )
    {
