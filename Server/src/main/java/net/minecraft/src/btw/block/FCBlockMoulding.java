...
{
	public static final double m_dMouldingWidth = 0.5D;
	public static final double m_dMouldingHalfWidth = ( m_dMouldingWidth / 2D );
	
	public static final double m_dMouldingLength = 1D;
	...
	public int m_iMatchingCornerBlockID;
	
	String m_sTextureName;
	
	public FCBlockMoulding( int iBlockID, Material material, String sTextureName, 
