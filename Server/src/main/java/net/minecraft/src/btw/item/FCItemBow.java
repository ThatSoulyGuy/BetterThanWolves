...
public class FCItemBow extends ItemBow
{
    ...
    public float GetCurrentPullStrength( EntityPlayer player, ItemStack itemStack, int iTicksInUseRemaining )
    {
    ...
    public void ApplyBowEnchantmentsToArrow( ItemStack bowStack, EntityArrow entityArrow )
    {
