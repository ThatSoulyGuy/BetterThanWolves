...
{
	public static FCModelBlockSpike m_model = new FCModelBlockSpike();
	...
	public boolean CanConnectToBlockToFacing( IBlockAccess blockAccess, 
	...
	public boolean IsConnectedSpikeToFacing( IBlockAccess blockAccess, 
		int i, int j, int k, int iFacing )
	{
		FCUtilsBlockPos targetPos = new FCUtilsBlockPos( i, j, k, iFacing );
