...
public class FCBlockStem extends BlockStem
{
    ...
    public FCBlockStem( int iBlockID, Block fruitBlock )
    {
    ...
    public boolean HasSpaceToGrow( World world, int i, int j, int k )
    {
    ...
    public boolean CanGrowFruitAt( World world, int i, int j, int k )
    {
