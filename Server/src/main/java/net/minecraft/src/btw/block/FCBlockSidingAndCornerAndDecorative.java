...
public class FCBlockSidingAndCornerAndDecorative extends FCBlockSidingAndCorner
{
	...
	public FCBlockSidingAndCornerAndDecorative( int iBlockID, Material material, String sTextureName, float fHardness, float fResistance, StepSound stepSound, String name )
	{
