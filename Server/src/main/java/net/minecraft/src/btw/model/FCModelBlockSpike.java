...
{
    public static final double m_dShaftWidth = ( 1D / 16D );
    public static final double m_dShaftHalfWidth = ( m_dShaftWidth / 2D );
    
    public static final double m_dBaseWidth = ( 4D / 16D );
    public static final double m_dBaseHalfWidth = ( m_dBaseWidth / 2D );
    public static final double m_dBaseHeight = ( 2D / 16D );
    public static final double m_dBaseHalfHeight = ( m_dBaseHeight / 2D );
    
	public static final double m_dBallWidth = ( 3D / 16D );
    public static final double m_dBallHalfWidth = ( m_dBallWidth / 2D );
    public static final double m_dBallVeticalOffset = ( 10D / 16D );
    
    public static final double m_dCandleHolderWidth = ( 4D / 16D );
    public static final double m_dCandleHolderHalfWidth = ( m_dCandleHolderWidth / 2D );
    public static final double m_dCandleHolderHeight = ( 1D / 16D );
    public static final double m_dCandleHolderHalfHeight = ( m_dCandleHolderHeight / 2D );
    
    public static final double m_dCandleHolderVeticalOffset = ( 1D - m_dCandleHolderHeight );
    
    public static final double m_dCenterBraceWidth = ( 3D / 16D );
    public static final double m_dCenterBraceHalfWidth = ( m_dCenterBraceWidth / 2D );
    public static final double m_dCenterBraceHeight = ( 4D / 16D );
    public static final double m_dCenterBraceHalfHeight = ( m_dCenterBraceHeight / 2D );
    public static final double m_dCenterBraceVeticalOffset = ( 0.5D - m_dCenterBraceHalfHeight ); 
    
    public static final double m_dSideSupportLength = ( 8D / 16D );
    public static final double m_dSideSupportWidth = ( 1D / 16D );
    public static final double m_dSideSupportHalfWidth = ( m_dSideSupportWidth / 2D );
    public static final double m_dSideSupportHeight = ( 2D / 16D );
    public static final double m_dSideSupportHalfHeight = ( m_dSideSupportHeight / 2D );
    public static final double m_dSideSupportVeticalOffset = ( 0.5D - m_dSideSupportHalfHeight );
    
    public static final double m_dBoundingBoxWidth = ( 4D / 16D );
