...
{
    public FCBlockStairsBase( int iBlockID, Material material )
    {
    ...
    public int ConvertDirectionToFacing( int iDirection )
    {
    ...
    public AxisAlignedBB GetBoundsFromPoolForBase( IBlockAccess blockAccess, int i, int j, int k )
    {
    	return GetBoundsFromPoolForBase( blockAccess.getBlockMetadata( i, j, k ) );
    }
    
    public AxisAlignedBB GetBoundsFromPoolForBase( int iMetadata )
    {
    ...
    public boolean GetBoundsForSecondaryPiece( IBlockAccess blockAccess, int i, int j, int k, AxisAlignedBB box )
    {
    ...
    public AxisAlignedBB GetBoundsFromPoolForSecondaryPiece( int iMetadata )
    {
     ...
     */
    public int GetBoundsForTertiaryPiece( IBlockAccess blockAccess, int i, int j, int k, AxisAlignedBB box )
    {
        int iMetadata = blockAccess.getBlockMetadata(i, j, k);
    ...
    public boolean IsStairBlock( int iBlockID )
    {
    ...
    public int SetUpsideDown( int iMetadata )
    {
    	return iMetadata | 4;
    }
    ...
    public void SetDirection( World world, int i, int j, int k, int iDirection )
	{
    ...
    public int SetDirection( int iMetadata, int iDirection )
	{
        iMetadata &= ~3;
    ...
    public int GetDirection( IBlockAccess blockAccess, int i, int j, int k )
    {
    	return GetDirection( blockAccess.getBlockMetadata( i, j, k ) );
    }
    
    public int GetDirection( int iMetadata )
	{
    	return iMetadata & 3;
	}
    
    public boolean IsStairBlockWithMetadata( IBlockAccess blockAccess, int i, int j, int k, int iMetadata )
    {
        return FCUtilsWorld.IsStairBlock( blockAccess, i, j, k ) && blockAccess.getBlockMetadata( i, j, k ) == iMetadata;
    }

    public void NotifyAllNearbyBlocksFlat( World world, int i, int j, int k )
    {
