...
{
	public static final int m_iAdjacentTreeBlockArrayWidth = 32;
	public static final int iArrayWidthHalf = m_iAdjacentTreeBlockArrayWidth / 2;
    public static final int m_iAdjacentTreeBlockSearchDist = 4;
    public static final int m_iAdjacentTreeBlockChunkCheckDist = m_iAdjacentTreeBlockSearchDist + 1;    
	
    public int[][][] m_iAdjacentTreeBlocks = new int[m_iAdjacentTreeBlockArrayWidth][m_iAdjacentTreeBlockArrayWidth][m_iAdjacentTreeBlockArrayWidth]; 
	
    public FCBlockLeaves( int iBlockID )
    {
        super( iBlockID );    
    ...
    public void UpdateAdjacentTreeBlockArray( World world, int i, int j, int k )
    {
