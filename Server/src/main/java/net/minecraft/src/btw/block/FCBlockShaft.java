...
{
	public static final double m_dShaftWidth = 0.125D;
	public static final double m_dShaftHalfWidth = ( m_dShaftWidth / 2D );
	public static final double m_dShaftHeight = 0.75D;

	public static final double m_dSelectionBoxWidth = ( m_dShaftWidth + ( 2D / 16D ) );
	public static final double m_dSelectionBoxHalfWidth = ( m_dSelectionBoxWidth / 2D );
	public static final double m_dSelectionBoxHeight = m_dShaftHeight + ( 1D / 16D );
