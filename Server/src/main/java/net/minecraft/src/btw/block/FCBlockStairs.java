...
{
    public final Block m_referenceBlock;
    public final int m_iReferenceBlockMetadata;
    
    public FCBlockStairs( int iBlockID, Block referenceBlock, int iReferenceBlockMetadata )
    {
