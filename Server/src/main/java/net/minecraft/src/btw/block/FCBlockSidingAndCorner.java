...
{
	public static final double m_dSidingHeight = 0.5D;
	
	public static final double m_dCornerWidth = 0.5D;
	public static final double m_dCornerWidthOffset = ( 1D - m_dCornerWidth );
	
	String m_sTextureName;
	
	public FCBlockSidingAndCorner( int iBlockID, Material material, String sTextureName, float fHardness, float fResistance, StepSound stepSound, String name )
	{
