...
public class FCBlockPistonBase extends BlockPistonBase
{
    ...
    public int GetPistonShovelEjectionDirection( World world, int i, int j, int k, int iToFacing )
    {
    ...
    public boolean CanShovelEjectToFacing( World world, int i, int j, int k, int iFacing )
    {
	...
	public void OnShovelEjectIntoBlock( World world, int i, int j, int k )
	{
    	Block block = Block.blocksList[world.getBlockId( i, j, k )];
