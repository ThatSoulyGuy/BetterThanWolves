	...
	implements FCIBlockMechanical
{
	...
	public static final float m_fSpoutHeight = 0.25F;
	public static final float m_fSpoutWidth = ( 6F / 16F );
	public static final float m_fSpoutHalfWidth = ( m_fSpoutWidth / 2F );
	
	public FCBlockHopper( int iBlockID )
	{
