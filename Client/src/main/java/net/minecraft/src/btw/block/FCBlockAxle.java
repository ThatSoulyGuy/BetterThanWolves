...
{
	public static final double m_dAxleWidth = 0.25D;
	public static final double m_dAxleHalfWidth = ( m_dAxleWidth / 2D );
	
	static public final int iAxleTickRate = 1;
	
	public static final int[][] m_AxleFacingsForAlignment = new int[][] { { 0, 1 }, { 2, 3 }, { 4, 5 } };

	public FCBlockAxle( int iBlockID )
	{
