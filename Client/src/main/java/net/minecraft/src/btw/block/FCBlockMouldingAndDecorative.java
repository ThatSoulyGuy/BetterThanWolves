...
public class FCBlockMouldingAndDecorative extends FCBlockMoulding
{
    ...
    public static final double m_dColumWidth = ( 10D / 16D );
    public static final double m_dColumHalfWidth = ( m_dColumWidth / 2D );
    
    public static final double m_dPedestalBaseHeight = ( 12D / 16D);
    public static final double m_dPedestalMiddleHeight = ( 2D / 16D );
    public static final double m_dPedestalMiddleWidth = ( 14D / 16D );
    public static final double m_dPedestalMiddleHalfWidth = ( m_dPedestalMiddleWidth / 2D );
    public static final double m_dPedestalTopHeight = ( 2D / 16D );
    public static final double m_dPedestalTopWidth = ( 12D / 16D );
    public static final double m_dPedestalTopHalfWidth = ( m_dPedestalTopWidth / 2D );
    
    public static final double m_dTableTopHeight = ( 2D / 16D );
    public static final double m_dTableLegHeight = ( 1D - m_dTableTopHeight );
    public static final double m_dTableLegWidth = ( 4D / 16D );
    public static final double m_dTableLegHalfWidth = ( m_dTableLegWidth / 2D );
	...
	public FCBlockMouldingAndDecorative( int iBlockID, Material material, String sTextureName, String sColumnSideTextureName, int iMatchingCornerBlockID, 
	...
	public FCBlockMouldingAndDecorative( int iBlockID, Material material, 
     ...
     * type they represent.
     */
    public void RenderDecorativeInvBlock( RenderBlocks renderBlocks, Block block, int iItemDamage, float fBrightness )
    {    	
    	switch ( iItemDamage )
    	{
    		case m_iSubtypePedestalUp:
