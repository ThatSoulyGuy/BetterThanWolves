...
{		
    public FCBlockFire( int iBlockID )
    {
    	super( iBlockID );
    }
    ...
    public void TryToDestroyBlockWithFire( World world, int i, int j, int k, int iChanceToDestroy, Random random, int iSourceMetadata )
    {
    ...
    public static int GetChanceOfNeighborsEncouragingFireCustom( World world, int i, int j, int k)
    {
