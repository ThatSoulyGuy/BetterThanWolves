...
{
    public FCBlockFarmlandBase( int iBlockID )
    {
    ...
    public boolean IsHydrated( World world, int i, int j, int k )
    {
    	return IsHydrated( world.getBlockMetadata( i, j, k ) );
    }
    
    public abstract boolean IsHydrated( int iMetadata );
    
    public void SetFullyHydrated( World world, int i, int j, int k )
    {
    ...
    public abstract int SetFullyHydrated( int iMetadata );
    
	public abstract void DryIncrementally( World world, int i, int j, int k );
	
    public abstract boolean IsFertilized( IBlockAccess blockAccess, int i, int j, int k );
    ...
    public boolean DoesBlockAbovePreventSoilReversion( World world, int i, int j, int k )
    {
    ...
    public Icon m_iconTopWet;
    public Icon m_iconTopDry;
