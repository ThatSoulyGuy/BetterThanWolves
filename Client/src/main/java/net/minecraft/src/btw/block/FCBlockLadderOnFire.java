...
public class FCBlockLadderOnFire extends FCBlockLadderBase
{
    ...
    public FCBlockLadderOnFire( int iBlockID )
    {
        super( iBlockID );
    ...
    public void LightLadderAtLocationIfPresent( World world, int i, int j, int k )
    {
    ...
    public void Extinguish( World world, int i, int j, int k )
    {
    ...
    public boolean IsRainingOnLadder( World world, int i, int j, int k )
    {
    	return world.IsRainingAtPos( i, j, k );
    }
    
    public int GetBurnCounter( IBlockAccess blockAccess, int i, int j, int k )
    {
    	return GetBurnCounter( blockAccess.getBlockMetadata( i, j, k ) );
    }
    
    public int GetBurnCounter( int iMetadata )
    {
    	return ( iMetadata >> 2 ) & 3;
    }
    
    public void SetBurnCounter( World world, int i, int j, int k, int iCounter )
    {
    ...
    public int SetBurnCounter( int iMetadata, int iCounter )
    {
    	iMetadata &= ~12;
