...
public abstract class FCBlockCrops extends FCBlockPlants
{
    ...
    public FCBlockCrops( int iBlockID )
    {
    ...
    public abstract int GetCropItemID();
    
    public abstract int GetSeedItemID();
    ...
    public void SetGrowthLevel( World world, int i, int j, int k, int iLevel )
    {
    ...
    public void SetGrowthLevelNoNotify( World world, int i, int j, int k, int iLevel )
    {
    	int iMetadata = world.getBlockMetadata( i, j, k ) & (~7); // filter out old level   	
    ...
    public boolean IsFullyGrown( World world, int i, int j, int k )
    {
    ...
    public void RenderCrops( RenderBlocks renderer, int i, int j, int k )
    {
