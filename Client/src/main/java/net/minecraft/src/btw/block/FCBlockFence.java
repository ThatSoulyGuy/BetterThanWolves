...
{
	public static final FCModelBlockFence m_model = new FCModelBlockFence();
	
    public final String m_sIconName;
    ...
    public boolean CanConnectToBlockToFacing( IBlockAccess blockAccess, int i, int j, int k, int iFacing )
    {
    ...
    public boolean CanConnectToBlockAt( IBlockAccess blockAccess, int i, int j, int k )
    {
    ...
    public FCModelBlock AssembleTemporaryModel( IBlockAccess blockAccess, int i, int j, int k )
    {
