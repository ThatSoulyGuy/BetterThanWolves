...
public abstract class FCBlockSlab extends Block
{
    ...
    public boolean HasNeighborWithMortarInContact( World world, int i, int j, int k, boolean bIsUpsideDown )
    {
    	if ( bIsUpsideDown )
    	{
    ...
    public boolean HasStickySnowNeighborInContact( World world, int i, int j, int k, boolean bIsUpsideDown )
    {
    	if ( bIsUpsideDown )
    	{
    ...
    public AxisAlignedBB GetBlockBoundsFromPoolFromMetadata( int iMetadata )
    {
