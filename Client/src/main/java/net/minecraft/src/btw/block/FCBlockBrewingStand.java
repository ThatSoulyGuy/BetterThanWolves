...
{
	public static final double m_dBaseHeight = 0.125D;	
	public static final double m_dBaseWidth = ( 1D - ( 2D / 16D ) );
	public static final double m_dBaseHalfWidth = ( m_dBaseWidth / 2D );
	
	public static final double m_dCenterColumnWidth = ( 2D / 16D );
	public static final double m_dCenterColumnHalfWidth = ( m_dCenterColumnWidth / 2D );
	
	public static final double m_dCenterAssemblyWidth = ( 10D / 16D );
	public static final double m_dCenterAssemblyHalfWidth = ( m_dCenterAssemblyWidth / 2D );
