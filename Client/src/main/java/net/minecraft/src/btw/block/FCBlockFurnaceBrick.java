...
{
    public final FCModelBlock m_modelBlockInterior = new FCModelBlockFurnaceBrick();
    
    public final float m_fClickYTopPortion = ( 6F / 16F ); 
    public final float m_fClickYBottomPortion = ( 6F / 16F ); 
    	
    public FCBlockFurnaceBrick( int iBlockID, boolean bIsLit )
    {
