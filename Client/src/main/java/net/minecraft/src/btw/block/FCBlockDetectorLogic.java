...
public class FCBlockDetectorLogic extends Block
{
    ...
    public boolean ShouldBeProjectingToFacing( IBlockAccess blockAccess, int i, int j, int k, int iFacing )
    {
    ...
    public boolean ShouldBeGlowingToFacing( World world, int i, int j, int k, int iFacing )
    {
    	FCUtilsBlockPos targetPos = new FCUtilsBlockPos( i, j, k );
		targetPos.AddFacingAsOffset( iFacing );
	...
	public void PropagateBeamsThroughBlock( World world, int i, int j, int k )
	{
