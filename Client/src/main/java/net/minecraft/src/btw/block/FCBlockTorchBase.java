...
{
    public FCBlockTorchBase( int iBlockID )
    {
    ...
    public boolean canPlaceTorchOn( World world, int i, int j, int k)
    {
    	return FCUtilsWorld.DoesBlockHaveSmallCenterHardpointToFacing( world, i, j, k, 1, true );
    }
    
    public boolean ValidateState( World world, int i, int j, int k, int iNeighborID )
    {
