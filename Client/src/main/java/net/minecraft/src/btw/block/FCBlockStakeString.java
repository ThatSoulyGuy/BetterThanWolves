...
public class FCBlockStakeString extends Block
{
	...
	public int ComputeStringLength( World world, int i, int j, int k )
	{
		int iLength = 0;
	...
	public int ComputeStringLengthAlongAxis( World world, int i, int j, int k, int iAxis )
	{
		int iLength = 0;
	...
	public int ComputeStringLengthToFacing( World world, int i, int j, int k, int iFacing )
	{
		int iLength = 0;
	...
	public int GetFirstFacingForAxis( int iAxis )
	{
		if ( iAxis == 0 )
		{
			return 4;
