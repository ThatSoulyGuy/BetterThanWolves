...
public class FCBeaconEffectLocation {
    ...
    public FCBeaconEffectLocation() {
        m_iIPos = 0; m_iJPos = 0; m_iKPos = 0; m_iEffectLevel = 0; m_iRange = 0;
    }

    public FCBeaconEffectLocation(int iIPos, int iJPos, int iKPos, int iEffectLevel, int iRange) {
        m_iIPos = iIPos; m_iJPos = iJPos; m_iKPos = iKPos; m_iEffectLevel = iEffectLevel; m_iRange = iRange;
    }

    public FCBeaconEffectLocation(NBTTagCompound tagCompound) { LoadFromNBT(tagCompound); }
