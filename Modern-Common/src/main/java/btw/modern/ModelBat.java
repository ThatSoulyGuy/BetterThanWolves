...
public class ModelBat extends ModelBase
{
    ...
    {
        EntityLiving var8 = (EntityLiving)par1Entity;

        boolean hanging = false; try { hanging = (Boolean) var8.getClass().getMethod("getIsBatHanging").invoke(var8); } catch (Exception ignored) {} if (hanging)
        {
