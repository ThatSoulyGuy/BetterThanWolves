...
public class ModelWolf extends ModelBase
{
    ...
    {
        EntityLiving var5 = par1EntityLiving;
        boolean angry = false;
        try {
            java.lang.reflect.Method isAngry = var5.getClass().getMethod("isAngry");
            angry = (Boolean) isAngry.invoke(var5);
            if (!angry) {
                java.lang.reflect.Method isWild = var5.getClass().getMethod("IsWildAndHostile");
                angry = (Boolean) isWild.invoke(var5);
            }
        ...
        try { sitting = (Boolean) var5.getClass().getMethod("isSitting").invoke(var5); } catch (Exception ignored) {}
        if (sitting)
        {
        ...
        try {
            java.lang.reflect.Method interested = var5.getClass().getMethod("getInterestedAngle", float.class);
            java.lang.reflect.Method shake = var5.getClass().getMethod("getShakeAngle", float.class, float.class);
            this.wolfHeadMain.rotateAngleZ = (Float) interested.invoke(var5, par4) + (Float) shake.invoke(var5, par4, 0.0F);
            this.wolfMane.rotateAngleZ = (Float) shake.invoke(var5, par4, -0.08F);
            this.wolfBody.rotateAngleZ = (Float) shake.invoke(var5, par4, -0.16F);
            this.wolfTail.rotateAngleZ = (Float) shake.invoke(var5, par4, -0.2F);
        } catch (Exception ignored) {}
        try {
            java.lang.reflect.Method grazeV = var5.getClass().getMethod("GetGrazeHeadVerticalOffset", float.class);
            java.lang.reflect.Method grazeR = var5.getClass().getMethod("GetGrazeHeadRotation", float.class);
            wolfHeadMain.rotationPointY = 13.5F + (Float) grazeV.invoke(var5, par4) * 5.0F;
            m_fHeadRotation = (Float) grazeR.invoke(var5, par4);
        } catch (Exception ignored) {}
        try {
            java.lang.reflect.Method possession = var5.getClass().getMethod("GetPossessionHeadRotation");
            wolfHeadMain.rotateAngleZ += (Float) possession.invoke(var5);
        } catch (Exception ignored) {}
    }
