...
public class FCSpawnLocation {
    ...
    public FCSpawnLocation() { m_iIPos = 0; m_iJPos = 0; m_iKPos = 0; m_lSpawnTime = 0; }

    public FCSpawnLocation(int iIPos, int iJPos, int iKPos, long iSpawnTime) {
        m_iIPos = iIPos; m_iJPos = iJPos; m_iKPos = iKPos; m_lSpawnTime = iSpawnTime;
    }

    public FCSpawnLocation(NBTTagCompound tagCompound) { LoadFromNBT(tagCompound); }
