...
public class ModelIronGolem extends ModelBase
{
    ...
    public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4)
    {
        ...
        int var6 = 0; try { var6 = (Integer) var5.getClass().getMethod("getAttackTimer").invoke(var5); } catch (Exception ignored) {}
        ...
        {
            int var7 = 0; try { var7 = (Integer) var5.getClass().getMethod("getHoldRoseTick").invoke(var5); } catch (Exception ignored) {}
