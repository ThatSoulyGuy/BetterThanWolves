...
// 1.5.2 vanilla/server VillageDoorInfo.java — verbatim port; fields/methods read by
// frozen EntityAIMoveIndoors (getInsidePosX/Y/Z, posY), EntityAIMoveThroughVillage
// (posX/Y/Z, getDistanceSquared), EntityAIRestrictOpenDoor (isDetachedFromVillageFlag,
// getInsideDistanceSquare, isInside, incrementDoorOpeningRestrictionCounter)
